...
export class BackendStack extends cdk.Stack {
    public backendTask: QSTaskMain;
    public taskName: string;

    constructor(scope: Construct, id: string, backendProps: BackendStackProps) {
        ...
        const envParams: { [key: string]: string } = {
            ...
            APP_CONTEXT_PATH: "/" + backendProps.contextPath,
        };

        // Create a Cloud Map namespace for service discovery
        const springbootAppNamespace = backendProps.clusterConstruct.appNamespace;
        this.taskName = backendProps.contextPath;

        this.backendTask = new QSTaskMain(this, this.taskName, {
            stackName: this.stackName,
            taskName: this.taskName,
            cluster: backendProps.clusterConstruct.cluster,
            memoryLimitMiB: 1024,
            cpu: 512,
            repo: privateEcrRepo,
            repoTag: "latest",
            ...
            desiredCount: 1,
            securityGroup:
                backendProps.clusterNetworkStack.network.preconfiguredVpcCidrAccessHttpSecurityGroup,
        ...
        cdk.Tags.of(this.backendTask).add("Environment", "RnD");
        cdk.Tags.of(this.backendTask).add("billing-code", "ICRQ-1843");
